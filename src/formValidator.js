...
class FormValidator {
    ...
    valida(state) {
        ...
        // começa assumindo que está tudo válido, recebe o objeto do método valido.
        ...
        this.validacoes.forEach(regra => {
            ...
            if (!validacao[regra.campo].isInvalid) {
                ...
                // Determina o valor do campo, o método a ser invocado e os argumentos opcionais pela definição da regra
